...
interface HomeProps {
  navigation: any; // Replace with proper navigation type if using typed navigation
}
...
const Home: React.FC<HomeProps> = ({ navigation }) => {
  ...
  const updateState = (data: Partial<LocationState>) =>
    ...
    <View style={styles.container}>
      ...
      <View style={{ flex: 1 }}>
        ...
        >
          ...
          {Object.keys(destinationCords).length > 0 && destinationCords.latitude && destinationCords.longitude && (
            <Marker coordinate={{ latitude: destinationCords.latitude, longitude: destinationCords.longitude }} image={imagePath.icGreenMarker} />
          )}
